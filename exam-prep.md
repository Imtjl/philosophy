...
**Теоретическая философия Канта - это ответ на вопрос: "Как возможно достоверное
научное знание?" Как мы можем познавать мир, если наш разум ограничен, а опыт
может обманывать?**

Кант видит кризис в философии познания. С одной стороны, эмпирики (Юм) говорят:
"Всё знание из опыта" → но тогда нет гарантии истинности. С другой стороны,
рационалисты говорят: "Истинное знание из разума" → но тогда нет нового знания о
мире.

**Центральный вопрос:** Как возможны математика и естественные науки? Почему их
законы работают с такой точностью?

**Драма познания:** Мы хотим познать мир, но заперты в своем сознании. Как выйти
за его пределы?
...
- Поэтому геометрия (наука о пространстве) и арифметика (последовательность во
  времени) достоверны

**Пример:** Ты видишь не "стол в пространстве", а твое сознание организует
зрительные ощущения в пространственную форму.
...
**Пример:** Видишь падающий камень → рассудок автоматически думает в категории
"причина-действие" → "что-то заставило камень упасть".

##### 3. Разум (стремление к целостности)

**Функция:** Искать безусловное, абсолютное, завершенное знание

**Проблема разума:** Он требует найти последние основания всего, но это
превышает возможности познания.
...
Формы познания (пространство, время, категории) определяют, какими нам являются
предметы
...
- Кант: не сознание приспосабливается к миру, а мир (как явление)
  приспосабливается к сознанию
...
- Все мои представления сопровождаются сознанием того, что это МЬИЕ
  представления
...
**Без единства самосознания не было бы вообще никакого опыта, только хаос
ощущений.**
...
**Тезис:** Мир имеет начало во времени и границы в пространстве **Антитезис:**
Мир безначален во времени и бесконечен в пространстве

**Проблема:** Оба утверждения можно "доказать", но они противоречат друг другу

**2. Антиномия простого и сложного**

**Тезис:** Всё состоит из простых частей **Антитезис:** Нет ничего простого, всё
сложно

**3. Антиномия причинности и свободы**

**Тезис:** Кроме причинности по законам природы, есть свобода **Антитезис:** Нет
никакой свободы, всё происходит по законам природы

**4. Антиномия необходимого существа**

**Тезис:** Существует абсолютно необходимое существо **Антитезис:** Нигде нет
абсолютно необходимого существа

##### Решение антиномий:

**Кант говорит:** Эти противоречия возникают, когда мы пытаемся применить
категории рассудка к вещам в себе.

**Правильно:** Категории работают только в мире явлений **Неправильно:**
Пытаться познать мир в целом, душу в себе, Бога как объект

#### Критика традиционных доказательств бытия Бога

Кант сам непосредственно занимался критикой этих доказательств в отдельном
разделе своей ~~писанины~~ труда.

##### Почему нельзя доказать существование Бога:

**1. Онтологическое доказательство** (от понятия к существованию)

- "Бог = самое совершенное существо → существование = совершенство → Бог
  существует"
...
- **Ошибка:** Категория причинности работает только в мире явлений, не за его
  пределами
...
**Главное открытие:** Мы познаем не мир сам по себе, а мир, как он является
нашему сознанию.

**Следствие:** Наука возможна и достоверна, но ограничена миром явлений. За
пределами опыта разум создает иллюзии.

**Революционность:** Не сознание приспосабливается к предметам, а предметы
приспосабливаются к формам нашего сознания.
...
> Кант нашел "средний путь" - обосновал возможность науки, но показал границы
> разума.
