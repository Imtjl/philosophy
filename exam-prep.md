...
"В Средние века центральной проблемой стало соотношение веры и разума в
контексте столкновения христианского и античного мировоззрений, а в эпоху
Возрождения произошел переход от теоцентризма к антропоцентризму"

Чтобы подвести к проблеме веры и разума,

##### Чуть истории

В средние века (V-XVвв), после падения римской империи, христианство стало
господствующей религией Европы. Античная философия казалась **языческой и
опасной**.

Главный вопрос и конфликт тут веры и разума: а можно ли использовать языческую
философию для объяснения христианской веры?

##### Столкновение мировоззрений

ДРЕВНЯЯ ГРЕЦИЯ:

- Космос неподвижен, время застыло, мир вечен
- Боги здесь, в нашем мире
- Творение = упорядочивание форм и материи

БЛИЖНИЙ ВОСТОК (иудео-христианство):

- Время разрушительно, мир временен
- Бог не от мира сего, существует иной мир (рай)
- Человек = in via (в пути к Богу)
- Мир = абсолютное творение из ничего (ex nihilo)

РАЗЛИЧИЕ ГРЕКОВ И ХРИСТИАН:

Греки: вечная жизнь = существование эйдоса (идеи) после смерти  
Христиане: "ни один волос не пропадет" = воскресение во плоти

##### Конфликт веры и разума

Религия говорит: бог троичен (отец, сын, святой дух = 1) Логика говорит:
1+1+1=3. Противоречие!

Религия говорит: Бог всемогущ и добр Разум спрашивает: Тогда почему в мире есть
зло?

Дилемма: принять веру - отказ от разума. Принять разум - отказ от веры

Решение этого конфликта => Патристика

##### Патристика (II-VIIвв)

Это учение святых отцов Церкви, ранняя форма.

Важный представитель - Августин Блаженный. Это отец некой церкви (патрес - отцы)

Хоть Августин вроде как и не придумывал Патристику, но он её представлял, и суть
Патристики в том, что она соединила _Платона с христианством_.

Решение проблемы: "Верь, чтобы понять" - сначала поверь, а потом дойдёшь
разумом.

Использование Платона:

- Мир идей == замысел Бога в божественном разуме
- Материальный мир = творения Бога по замыслам из мира идей
- Познание истины (анамнезис) - это не припоминание, а **божественное озарение**

Идеи Августина:

1. Осмыслял библейские сюжеты. Концепция времени:
   - Солнце стояло, а время шло (время не зависит от движения)
   - Время - растяжение души
   - Прошлого уже нет, будущего ещё нет, настоящее - мгновения
   - Время - творение Бога (до сотворения мира времени не было)

Пример патристики: "Ведь профессору по матану, чтоб понять матан"

###### Но есть проблема

Платон презирает материальный мир. Но Бог создал материю, а значит она хороша.
Нужна более христианская картина мира.

=> Схоластика

##### Схоластика (IX-XIVвв)

Грубо говоря, в Схоластике просто сменили Платона на Аристотеля.

Представитель, который опять же не придумыцвал Схоластику (а кто придумывал?) -
Фома Аквинский

Ещё раз, почему Платона на Аристотеля:

- Аристотель не презирал материю → материальный мир тоже от Бога
- Аристотель ценил единство души и тела: удобно для учения о воскресении во
  плоти

Решение проблемы веры и разума:

- "Философия - служанка богословия" (разум помогает вере)
- Двойственная истина - есть истины веры (откровение) и истины разума
  (докозательства)
- Вера и разум НЕ ПРОТИВОРЕЧАТ: они ведут к одной истине разными путями

##### Докозательства бытия бога

###### Онтологическое (Ансельм)

- Бог - абсолютный максимум совершенства
- В уме он есть, но вещь в реальности больше, чем просто понятие
- Значит, Бог существует реально

###### Космологические (Фома)

1. От движения - всё движется, должен быть первый двигатель -> это Бог
2. От причины - у всего есть причина, должна быть первопричина -> это Бог
3. От возможности - всё существует как реализованная возможность -> если бы Бога
   не было, то возможно и не было бы реальности
4. От степеней совершенства - есть более или менее совершенное, должно быть
   абсолютно совершенное
5. От целесообразности - всё имеет цель, должен быть разумный устроитель

По итогу: сущность Бога неизвестна, но мы понимаем, как он соотносится с миром

##### Эпоха возрождения

Что возрождали? => `Античную культуру в христианском контексте` - греческую и
римскую философию, искусство, литературу, науку.

От чего отходили? => `теоцентризм -> антропоцентризм`

- Теоцентризм - концепция, в которой Бог это центр всего сущего, источник всех
  благ и высший смысл жизни, человек - раб Божий.
- Антропоцентризм - концепция, где человек это центр Вселенной и цель всех
  событий в ней, соработник Бога.

`Аскетизм -> гуманизм`

(аскетизм - отказ от материальных благ и удобств в угоду духовного роста)

- в средневековье: отречение от мира, умервщление плоти
- в эпоху возрождения: утверждение земной жизни, наслаждение красотой

##### Пико Делла Мирандола

"Речь о достоинстве человека" - манифест гуманизма

Главная идея: "Человек - скульптор самого себя"

- Человек появляется без заданной формы, не готовым, его природа не определена
- Человек сам выбирает, кем стать, нет ораничений бытия
- Человек - единственное существо, которое МОЖЕТ изменить свою природу

Знаменитая цитата (Речь о достоинстве человека): "не даем мы тебе, Адам, ни
определенного места, ни собственного образа, чтобы какое место, какой образ ты
сам выберешь, то и имел бы по собственному желанию. Ты можешь переродиться в
низшие, неразумные существа, но может переродиться по велению своей души и в
высшие божественные."

##### Пример:

- Средневековье: "Бог создал меня крестьянином, такова его воля, смиренно
  принимаю"
- Возрождение: "Бог меня создал без определённой природы, я могу стать кем
  захочу - художником, ученым, айтишником, сыном маминой подруги - я сам творю


### Билет 7

#### Теоретическая философия И.Канта: «Критика чистого разума»


#### Основная проблема Канта:

**Теоретическая философия Канта - это ответ на вопрос: "Как возможно достоверное научное знание?" Как мы можем познавать мир, если наш разум ограничен, а опыт может обманывать?**

Кант видит кризис в философии познания. С одной стороны, эмпирики (Юм) говорят: "Всё знание из опыта" → но тогда нет гарантии истинности. С другой стороны, рационалисты говорят: "Истинное знание из разума" → но тогда нет нового знания о мире.

**Центральный вопрос:** Как возможны математика и естественные науки? Почему их законы работают с такой точностью?

**Драма познания:** Мы хотим познать мир, но заперты в своем сознании. Как выйти за его пределы?

#### Кантовское решение: априорные синтетические суждения

##### Типы суждений:

**1. Аналитические суждения:**
- "Все холостяки неженаты"
- Предикат уже содержится в субъекте
- Не дают нового знания, но достоверны

**2. Синтетические суждения:**
- "На улице идет дождь"  
- Предикат добавляет новую информацию
- Дают новое знание, но могут быть ошибочными

**3. Априорные суждения:**
- Не зависят от опыта
- Всеобщие и необходимые

**4. Апостериорные суждения:**
- Зависят от опыта
- Случайные, могут быть иными

#### Революционная идея Канта:

**Существуют АПРИОРНЫЕ СИНТЕТИЧЕСКИЕ суждения!**
- Дают новое знание (синтетические)
- И при этом достоверны (априорные)

**Примеры:**
- "7 + 5 = 12" (математика)
- "Всё, что происходит, имеет причину" (физика)
- "Кратчайшее расстояние между точками - прямая" (геометрия)

**Почему это важно:** На таких суждениях строится вся наука!

#### Три уровня познания

##### 1. Чувственность (созерцание)

**Функция:** Получать материал познания через ощущения
...
**Что это значит:**
- Мы не "видим" пространство и время в природе
- Наше сознание само "накладывает" их на ощущения
- Поэтому геометрия (наука о пространстве) и арифметика (последовательность во времени) достоверны

**Пример:** Ты видишь не "стол в пространстве", а твое сознание организует зрительные ощущения в пространственную форму.

##### 2. Рассудок (мышление)

**Функция:** Выносить суждения, связывать представления

**12 категорий рассудка** (априорные формы мышления):

**Группа количества:**
- Единство, множественность, цельность

**Группа качества:**  
- Реальность, отрицание, ограничение

**Группа отношения:**
- Субстанция-акциденция, причина-действие, взаимодействие

**Группа модальности:**
- Возможность, существование, необходимость

**Как работает:** Рассудок "подводит" чувственные данные под категории.

**Пример:** Видишь падающий камень → рассудок автоматически думает в категории "причина-действие" → "что-то заставило камень упасть".

##### 3. Разум (стремление к целостности)

**Функция:** Искать безусловное, абсолютное, завершенное знание

**Проблема разума:** Он требует найти последние основания всего, но это превышает возможности познания.

**Три идеи разума:**

**1. Душа** - абсолютный субъект всех психических явлений
- Ты думаешь: "За всеми моими мыслями стоит некое 'Я'"
- Но это только идея, доказать существование души нельзя

**2. Мир** - абсолютная тотальность всех явлений  
- Ты думаешь: "Должна быть общая картина всего мира"
- Но мир в целом нельзя созерцать

**3. Бог** - абсолютная реальность, основа всего сущего
- Ты думаешь: "Должна быть последняя причина всего"
- Но это предел мышления, а не объект познания

#### Явления и вещи в себе - главное открытие Канта

##### Революционная идея:

**Мы познаем не сами вещи, а только то, как они нам являются**

**Так и в чем суть революции в философии?**

- Традиционная философия: Наше познание должно `приспосабливаться` к предметам

Вещи существуют сами по себе

Мы пытаемся их познать "как они есть"

**Проблема**: откуда гарантия, что мы их правильно познаем?

- Кант переворачивает: Предметы должны `сообразовываться` с нашим познанием

Мы познаем вещи не "как они есть", а как они МОГУТ быть познаны

Формы познания (пространство, время, категории) определяют, какими нам являются предметы

Поэтому наука и достоверна - она изучает мир, организованный нашим сознанием

##### Тут можно привести аналогию с Коперником:

- Коперник: не Солнце вращается вокруг Земли, а Земля вокруг Солнца
- Кант: не сознание приспосабливается к миру, а мир (как явление) приспосабливается к сознанию

##### Что такое явления (феномены):

```text
Явления = вещи, как они даны нашему сознанию
```

- Организованы нашими формами чувственности (пространство, время)
- Обработаны нашими категориями рассудка (причинность, субстанция)
- Это всё, что мы можем познать

**Пример:** Ты видишь красную розу
- Красный цвет = как твое сознание обрабатывает световые волны
- Пространственная форма = как твое сознание организует ощущения
- То, что ты видишь = явление розы, не сама роза

**Но в чем основа всего познания?**

**Проблема**: Как из хаоса ощущений получается _единое_, связное знание?

**Ответ Канта:** Есть _изначальное_ единство самосознания - "Я мыслю"

- Все мои представления сопровождаются сознанием того, что это МЬИЕ представления
- "Я мыслю" должно быть способно сопровождать все мои представления
- Это единство "Я" и объединяет все познание в систему

> То есть простыми словами:
>
> Ты не просто видишь красное, слышишь звук, чувствуешь тепло
> 
> Ты сознаешь: "Я вижу красное", "Я слышу звук", "Я чувствую тепло"
> 
> Это единое "Я" и делает возможным связное познание

**Без единства самосознания не было бы вообще никакого опыта, только хаос ощущений.**

##### Что такое вещи в себе (ноумены):

**Вещи в себе** = вещи, какие они есть независимо от нашего сознания
- Мы ничего о них не знаем
- Не можем применить к ним категории
- Они существуют, но непознаваемы

**Почему непознаваемы:**
- Всё наше познание работает через формы сознания
- Мы не можем "выпрыгнуть" из своего сознания
- Поэтому никогда не узнаем, "какие вещи на самом деле"

### Аналогия с очками:

Представь, что ты родился в очках, которые нельзя снять:
- Ты видишь мир через эти очки (= формы сознания)
- Мир кажется тебе именно таким (= явления)
- Но каков мир БЕЗ очков? (= вещи в себе)
- Ты этого никогда не узнаешь

#### Границы познания и антиномии разума

##### Что происходит, когда разум пытается познать вещи в себе:

Разум создает **иллюзии** - думает, что может познать то, что непознаваемо.

##### Четыре антиномии (противоречия) чистого разума:

**1. Антиномия пространства и времени**

**Тезис:** Мир имеет начало во времени и границы в пространстве
**Антитезис:** Мир безначален во времени и бесконечен в пространстве

**Проблема:** Оба утверждения можно "доказать", но они противоречат друг другу

**2. Антиномия простого и сложного**

**Тезис:** Всё состоит из простых частей
**Антитезис:** Нет ничего простого, всё сложно

**3. Антиномия причинности и свободы**

**Тезис:** Кроме причинности по законам природы, есть свобода
**Антитезис:** Нет никакой свободы, всё происходит по законам природы

**4. Антиномия необходимого существа**

**Тезис:** Существует абсолютно необходимое существо
**Антитезис:** Нигде нет абсолютно необходимого существа

##### Решение антиномий:

**Кант говорит:** Эти противоречия возникают, когда мы пытаемся применить категории рассудка к вещам в себе.

**Правильно:** Категории работают только в мире явлений
**Неправильно:** Пытаться познать мир в целом, душу в себе, Бога как объект

#### Критика традиционных доказательств бытия Бога

Кант сам непосредственно занимался критикой этих доказательств в отдельном разделе своей ~~писанины~~ труда.

##### Почему нельзя доказать существование Бога:

**1. Онтологическое доказательство** (от понятия к существованию)
- "Бог = самое совершенное существо → существование = совершенство → Бог существует"
- **Ошибка:** Существование не является предикатом (свойством)
- "100 реальных талеров" не содержат больше денег, чем "100 возможных талеров"

**2. Космологическое доказательство** (от мира к первопричине)
- "Всё имеет причину → должна быть первопричина → это Бог"
- **Ошибка:** Категория причинности работает только в мире явлений, не за его пределами

**3. Физико-теологическое доказательство** (от порядка к разумному творцу)
- "В мире есть целесообразность → должен быть разумный создатель"
- **Ошибка:** Это может доказать только архитектора мира, но не Бога

#### Практическое значение "Критики чистого разума"

**1. Защита науки:**
- Наука работает в мире явлений
- Там ее законы действительно всеобщи и необходимы
- Математика и физика получают твердое основание

**2. Место для веры:**
- Разум не может ни доказать, ни опровергнуть существование Бога, души, свободы
- Остается место для практической веры (в морали)

**3. Скромность разума:**
- Разум должен знать свои границы
- Не пытаться познать непознаваемое

### Знаменитая фраза Канта:

```text
"Мне пришлось ограничить знание, чтобы дать место вере"
```

##### Итог теоретической философии Канта:

**Главное открытие:** Мы познаем не мир сам по себе, а мир, как он является нашему сознанию.

**Следствие:** Наука возможна и достоверна, но ограничена миром явлений. За пределами опыта разум создает иллюзии.

**Революционность:** Не сознание приспосабливается к предметам, а предметы приспосабливаются к формам нашего сознания.

Можно сказать, Кант _примирил_ три позиции:
1. Догматизм (рационалисты): "Можем познать всё разумом"

Кант: В мире явлений - да, за его пределами - нет

2. Скептицизм (Юм): "Ничего достоверно познать нельзя"

Кант: В мире явлений наука достоверна

3. Критицизм (Кант): "Можем познать, но в определенных границах"

> Кант нашел "средний путь" - обосновал возможность науки, но показал границы разума.

### Билет 6

#### Философия Нового времени (на примере концепции Р. Декарта)

##### Концепция

"Декарт создал метод радикального сомнения, чтобы найти абсолютно достоверное
знание для обоснования новой науки, и пришел к выводу 'мыслю, следовательно
существую', разделив мир на две субстанции - мыслящую и протяженную."

##### Контекст нового времени (XVIIвек)

Научная революция. В отличие от античности, мы пытаемся не просто понять
природу, но и господствовать над ней через математику и технику.

- Галилей - математизация природы
- Бэкон - экспериментальный метод
- Декарт - рациональный метод

Главная проблема - как обосновать новую науку, т.е. науку нового времени? Какой
**МЕТОД** даст достоверные знания?

##### Проблема метода - два лагеря

1. Рационализм (Декарт, Спиноза, Лейбниц)

   - Все знания заложены в разуме
   - Источник истины - врожденные идеи, логика

2. Эмпиризм (Бэкон, Локк, Юм)
   - Знания получают из опыта
   - Источник истины - чувственный опыт, эксперимент

> Декарт - главный рационалист!

##### Проблема Декарта

Как найти критерий достоверности знаний для науки?

Ответ: Достоверное знание = знание, в котором мы не можем сомневаться

Проблема с чувствами: нельзя строить науку на показаниях чувств - они
обманывают!

##### Метод радикального сомнения

Цель: усомниться во всем, что можно вообще поставить под сомнение
...
1. Опыт сна:
   ...
   - А что, если всё - сон?
   - В нём всё кажется реальным
   - Как отличин сон от яви?

2. Опыт злого гения:

   - А что, если есть злой гений, который меня обманывает?
   - Заставляет видепть иллюзии вместо реальности

   НО: даже если так, сам факт мышления об этом доказывает его существование
   **Вывод: Cogito ergo sum**
   ...
   1. Могу сомневаться во всём
   2. Но чтобы сомневаться, надо мыслить
   3. Чтобы мыслить, надо существовать
   4. Значит, если я мыслю - я существую

   Например, даже если я в матрице и всё вокруг иллюзия, я всё равно **думаю** о
   факте иллюзии, или иллюзорно думаю об иллюзии, не важно, всё равно где-то
   есть корень раздумий. Значит, существую.

3. Опыт с воском:
   - Кусок воска меняется (тает), но остаётся тем же воском
   - Чувства говорят: воск поменялся, это разные вещи
   - Разум говорит: это один и тот же воск
   - **Вывод: разум надёжнее чувств**

##### Дуализм Декарта

Из cogito Декарт выводит существование двух независимых субстанций

1. res cognitans - мыслящая вещь

   - душа, разум, сознание
   - неделимая, бессмертная, не имеющая протяжения в пространстве духовная
     субстанция

2. res extensa - протяженная вещь
   - материя, тело, природа
   - свойство: протяжение
   - делима, смертна, подчиняется законам механики

##### Ключевая проблема дуализма

Если душа не имеет протяжения, а тело только протяжение КАК они
взаимодействуют?  
Как нематериальная душа движет материальное тело?  
Как материальные впечатления влияют на нематериальную душу?

Пример: Ты решаешь поднять руку (душа) → рука поднимается (тело). КАК?

Это станет главной проблемой философии на 300 лет!

##### Два типа идей

1. Приобретённые идеи
   - приходят извне (цвет, звук, запах)
   - могут быть ложными
2. Врожденные идеи
   - Изначально есть в разуме
   - Составляют разумность
   - Всегда истинны

Например, 2+2=4 это врождённая идея. То что это место пахнет знакомо -
приобретённая идея.

##### О Боге и о том что он существует

Проблема: Откуда мы знаем, что врожденные идеи - истинны?

1. У меня есть идея совершенного существа (Бога)
2. Несовершенное (я) не может создать идею совершенного
3. Значит, Бог существует и вложил эту идею
4. Совершенный Бог не обманывает
5. Значит, врожденные идеи - истинны
...
```text
Локк: врожденных идей нет, сознание = чистый лист
Лейбниц: врожденные идеи есть, но в потенциальном виде
```

1. Эмпирист Джон Локк:

   - У детей, дикарей и идиотов нет врожденных идей
   - Абсурдно полагать, что у нас есть мысль, о которой мы не знаем
   - Знание не может быть бессознательным
   - Сознание - чистый лист
   - вся истина - из опыта

2. Рационалист Лейбниц:

Мир состоит из монад (единица, неделимая субстанция), где каждая монада
отображает мир со своей точки зрения, и монады не влияют друг на друга напрямую
и закрыты от воздействия внешнего мира

! Он ЗАЩИЩАЛ врожденные идеи против Локка !

- Знание может быть бессознательным - как непроросшее зерно
- Врожденные идеи есть, но не развиты (как это зерно непроросшее)
- Нужен опыт, чтобы знания ПРОЯВИТЬ
- Каждая монада содержит весь мир (отличаются степенью восприятия)

Суть спора: Есть ли врожденные идеи или всё из опыта?

##### СВЯЗЬ С ДРУГИМИ БИЛЕТАМИ (шпоргалка чтоб не запутаться)

С Парменидом: Оба ставили разум выше чувств  
С наукой: Обосновал математизацию природы  
С Кантом: Кант будет решать проблемы, поставленные Декартом  
Главное для экзамена: Декарт через радикальное сомнение нашел абсолютно
достоверную истину (cogito) и разделил мир на две субстанции, создав основу
